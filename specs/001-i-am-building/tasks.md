...
- [x] T005 [P] Initialize frontend React app with Vite: Create `frontend/package.json`, install React, Recharts, Axios, date-fns, setup ESLint, Prettier in `frontend/.eslintrc.js` and `frontend/prettier.config.js`.
